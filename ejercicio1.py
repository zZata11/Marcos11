...
def main(page: ft.Page):
    page.bgcolor = "#ffffff"  #color de fondo
    lista_de_compras = []
    ...
    def mostrar_dialogo_error():    #creamos un mensaje de error
        ...
        page.dialog = ft.AlertDialog(
            ...
            content=ft.Text("No puedes agregar un ítem en blanco.", color="#000000"), #Mostramos un mensaje de error
    ...
    def editar_clic(e, checkbox, item):  #creamos la funcion editar 
    ...
    def guardar_clic(e, checkbox, nuevo_valor, item):  #creamos la funcion guardar
    ...
    def guardar_archivo(e):  #guardamos las lista de compras
        if e.path:
    ...
    nueva_tarea = ft.TextField(hint_text="Agregar Producto", width=250, bgcolor="#ffffff")  # label para agregar productos
    ...
    texto_encabezado = ft.Text("Bienvenidos Super Ypacarai", size=20, weight=ft.FontWeight.BOLD, color="#000000") #titulo 
